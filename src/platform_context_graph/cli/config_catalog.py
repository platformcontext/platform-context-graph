...
DEFAULT_CONFIG = {
    ...
    "PCG_FACT_STORE_POOL_MAX_SIZE": "4",
    "PCG_FACT_QUEUE_POOL_MAX_SIZE": "4",
...
CONFIG_DESCRIPTIONS = {
    ...
    "PCG_FACT_STORE_POOL_MAX_SIZE": "Maximum psycopg connection-pool size for the facts store Postgres backend",
    "PCG_FACT_QUEUE_POOL_MAX_SIZE": "Maximum psycopg connection-pool size for the facts work queue Postgres backend",
    ...
    "PCG_SERVICE_URL": "Default remote PlatformContextGraph HTTP base URL for CLI commands",
    "PCG_SERVICE_PROFILE": "Default named remote profile suffix used to resolve PCG_SERVICE_URL_<PROFILE> and PCG_API_KEY_<PROFILE>",
    "PCG_REMOTE_TIMEOUT_SECONDS": "Default HTTP timeout in seconds for remote CLI requests",
