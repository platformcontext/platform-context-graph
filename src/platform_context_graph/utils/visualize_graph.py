...
def generate_visualization():
    """Generate an HTML graph visualization from the local FalkorDB store."""
    db_path = str(get_app_home() / "falkordb.db")
...
<html>
<head>
    <title>PCG Graph Visualization</title>
...
<body>
    <div class="header">
        <h1>PlatformContextGraph Visualizer</h1>
