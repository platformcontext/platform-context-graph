...
KUZU_NODE_TABLES: Sequence[tuple[str, str]] = [
    ...
    (
        "SqlTable",
        "uid STRING, name STRING, path STRING, line_number INT64, schema STRING, qualified_name STRING, type STRING, sql_entity_type STRING, lang STRING, PRIMARY KEY (uid)",
    ),
    (
        "SqlColumn",
        "uid STRING, name STRING, path STRING, line_number INT64, table_name STRING, column_name STRING, data_type STRING, type STRING, sql_entity_type STRING, lang STRING, PRIMARY KEY (uid)",
    ),
    (
        "SqlView",
        "uid STRING, name STRING, path STRING, line_number INT64, schema STRING, qualified_name STRING, type STRING, sql_entity_type STRING, lang STRING, PRIMARY KEY (uid)",
    ...
    (
        "SqlFunction",
        "uid STRING, name STRING, path STRING, line_number INT64, schema STRING, qualified_name STRING, function_language STRING, type STRING, sql_entity_type STRING, lang STRING, PRIMARY KEY (uid)",
    ),
    (
        "SqlTrigger",
        "uid STRING, name STRING, path STRING, line_number INT64, table_name STRING, function_name STRING, type STRING, sql_entity_type STRING, lang STRING, PRIMARY KEY (uid)",
    ),
    (
        "SqlIndex",
        "uid STRING, name STRING, path STRING, line_number INT64, table_name STRING, type STRING, sql_entity_type STRING, lang STRING, PRIMARY KEY (uid)",
    ),
...
KUZU_REL_TABLES: Sequence[tuple[str, str]] = [
    ...
    ("HAS_COLUMN", "FROM SqlTable TO SqlColumn"),
    ("REFERENCES_TABLE", "FROM SqlTable TO SqlTable"),
    ("READS_FROM", "FROM SqlView TO SqlTable, FROM SqlFunction TO SqlTable, FROM SqlView TO SqlView"),
    ("TRIGGERS_ON", "FROM SqlTrigger TO SqlTable"),
    ("EXECUTES", "FROM SqlTrigger TO SqlFunction"),
    ("INDEXES", "FROM SqlIndex TO SqlTable"),
    ("MIGRATES", "FROM File TO SqlTable, FROM File TO SqlView, FROM File TO SqlFunction, FROM File TO SqlTrigger, FROM File TO SqlIndex"),
    ("MAPS_TO_TABLE", "FROM Class TO SqlTable"),
    ("QUERIES_TABLE", "FROM Function TO SqlTable, operation STRING, api STRING"),
]
...
KUZU_UID_MAP: dict[str, list[str]] = {
    ...
    "SqlTable": ["name", "path", "line_number"],
    "SqlColumn": ["name", "path", "line_number"],
    "SqlView": ["name", "path", "line_number"],
    "SqlFunction": ["name", "path", "line_number"],
    "SqlTrigger": ["name", "path", "line_number"],
    "SqlIndex": ["name", "path", "line_number"],
}
