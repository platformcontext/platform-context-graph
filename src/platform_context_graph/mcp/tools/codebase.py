"""Tool definitions for codebase indexing, analysis, and repository management."""
...
CODEBASE_TOOLS = {
    ...
    "load_bundle": {
        "name": "load_bundle",
        "description": "Load a pre-indexed .pcg bundle into the database. Can load from local file or automatically download from registry if not found locally. Bundles are portable snapshots of indexed code that load instantly without re-indexing.",
        "inputSchema": {
            "type": "object",
            "properties": {
                "bundle_name": {
                    "type": "string",
                    "description": "Name of the bundle to load (e.g., 'flask', 'pandas', 'flask-main-2579ce9.pcg'). Can be a full filename or just the package name.",
                },
                "clear_existing": {
                    "type": "boolean",
