"""Tree-sitter parser support for Perl."""
...
class PerlTreeSitterParser:
    ...
    def __init__(self, generic_parser_wrapper):
        """Initialize the Perl parser with the shared tree-sitter wrapper."""
    ...
    def _get_parent_context(
        ...
        """Return the nearest enclosing Perl declaration."""
        curr = node.parent
        while curr:
    ...
    def _calculate_complexity(self, node):
        """Estimate cyclomatic complexity for a Perl AST node."""
        complexity_nodes = {
            "if_statement",
            "unless_statement",
            "for_statement",
        ...
        def traverse(n):
            """Traverse a Perl AST subtree and update complexity state."""
            nonlocal count
    ...
    def _find_functions(self, root_node):
        """Find Perl subroutine declarations."""
        functions = []
        seen_nodes = set()
    ...
    def _find_classes(self, root_node):
        """Find Perl package declarations."""
        classes = []
    ...
    def _find_imports(self, root_node):
        """Find Perl use/import statements."""
        imports = []
        seen_nodes = set()
    ...
    def _find_variables(self, root_node):
        """Find Perl variable declarations."""
        variables = []
