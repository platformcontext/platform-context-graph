"""Language-specific query dispatch for legacy advanced query tooling."""
...
class Advanced_language_query:
    ...
    def __init__(self, db_manager: DatabaseManager):
        """Store the database manager used to execute read-only queries."""
        self.db_manager = db_manager

    def advanced_language_query(self, language: str, query: str):
        """Execute a supported read-only language query."""
