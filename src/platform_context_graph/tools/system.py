"""System-level MCP and diagnostic tools."""
...
class SystemTools:
    ...
    def __init__(self, db_manager: DatabaseManager, job_manager: JobManager):
        """Initialize the system tool collection.

        Args:
            db_manager: Database manager used for read-only diagnostics.
            job_manager: Job manager used to inspect background job state.
        """
