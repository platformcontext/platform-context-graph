...
def test_graph_builder_init_does_not_build_parser_registry(monkeypatch) -> None:
    ...
    monkeypatch.setattr(graph_builder_module, "build_parser_registry", _unexpected_build)
...
def test_graph_builder_parse_file_builds_parser_registry_lazily(monkeypatch, tmp_path: Path) -> None:
    ...
    monkeypatch.setattr(graph_builder_module, "build_parser_registry", _build_registry)
    monkeypatch.setattr(
