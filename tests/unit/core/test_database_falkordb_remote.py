...
class TestFalkorDBRemoteManager:
    ...
    def _reset_singleton(self):
        ...
        from platform_context_graph.core.database_falkordb_remote import (
        ...
        if FalkorDBRemoteManager._instance and hasattr(
            FalkorDBRemoteManager._instance, "_initialized"
        ):
    ...
    def test_initialization_defaults(self):
        ...
        clean_env = {
            k: v for k, v in os.environ.items() if not k.startswith("FALKORDB_")
        }
    ...
    def test_ssl_variations(self):
        ...
        for val in ("false", "0", "no", ""):
            ...
            with patch.dict(os.environ, clean_env, clear=True):
                ...
                manager = FalkorDBRemoteManager()
                assert (
                    manager.ssl is False
                ), f"Expected ssl=False for FALKORDB_SSL={val}"
    ...
    def test_get_driver_import_error(self):
        ...
        with patch.dict(os.environ, clean_env, clear=True):
            ...
            with patch.dict("sys.modules", {"falkordb": None}):
                with patch(
                    "builtins.__import__", side_effect=ImportError("no falkordb")
                ):
...
class TestFactoryFalkorDBRemote:
    ...
    def test_explicit_falkordb_remote(self):
        ...
        clean_env = {
            ...
            if k not in ("DATABASE_TYPE", "DEFAULT_DATABASE", "PCG_RUNTIME_DB_TYPE")
