...
def test_deleted_compatibility_shim_paths_are_absent() -> None:
    ...
    forbidden_paths = (
        ...
        "src/platform_context_graph/collectors/git/indexing.py",
        "src/platform_context_graph/collectors/git/discovery.py",
        "src/platform_context_graph/collectors/git/parser_support.py",
