...
const (
	...
	reducerConflictDomainCodeCallIntents = "code_call_intents"
...
// older work for the same repo, while the domain separates work families that
// do not share the same write-hot spots.
func reducerConflictDomainKey(intent projector.ReducerIntent) (string, string) {
	...
	case reducer.DomainCodeCallMaterialization:
		return reducerConflictDomainCodeCallIntents, scopeKey
	case reducer.DomainSemanticEntityMaterialization,
