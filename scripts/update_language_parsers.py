...
LANGUAGES_DIR = Path(__file__).resolve().parent.parent / "src" / "platform_context_graph" / "tools" / "languages"


def update_imports(content: str) -> str:
    """Add execute_query import if not present."""
    if "from platform_context_graph.utils.tree_sitter_manager import execute_query" in content:
        return content
    
    # Find the last import statement
    import_pattern = r"(from platform_context_graph\.utils\.debug_log import[^\n]+)"
