...
files_by_lang = {
    "c": ["src/platform_context_graph/tools/languages/c.py"],
    "cpp": ["src/platform_context_graph/tools/languages/cpp.py"],
    "go": ["src/platform_context_graph/tools/languages/go.py"],
    "java": ["src/platform_context_graph/tools/languages/java.py"],
    "javascript": ["src/platform_context_graph/tools/languages/javascript.py"],
    "python": ["src/platform_context_graph/tools/languages/python.py"],
    "ruby": ["src/platform_context_graph/tools/languages/ruby.py"],
    "rust": ["src/platform_context_graph/tools/languages/rust.py"],
    "typescript": ["src/platform_context_graph/tools/languages/typescript.py"],
    "dart": ["src/platform_context_graph/tools/languages/dart.py"],
    "perl": ["src/platform_context_graph/tools/languages/perl.py"],
}
