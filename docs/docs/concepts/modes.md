...
- **ingestor** — the deployed indexing runtime. Internally this still uses the `ingester` runtime role and processes indexing jobs only, writing facts and projected graph state.
