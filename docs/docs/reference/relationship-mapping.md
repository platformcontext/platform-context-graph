...
- broader Jenkins / Groovy controller evidence beyond explicit shared-library and GitHub repository refs plus repository-context controller artifacts
