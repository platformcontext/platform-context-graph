...
| Terragrunt parity | `fail` | dependency edges, locals, and inputs are not fully queryable | locals, inputs, and dependency semantics are persisted and queryable | parser tests, relationship tests, query proof | shared HCL wave |
