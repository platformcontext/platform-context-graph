...
| Wave 1 | SQL/dbt lineage | largest semantic gap and mostly isolated; now narrowed to truly opaque templated expressions and opaque macro bodies, plus wrapped opaque forms that remain deliberately unresolved after macro-wrapper and template-wrapper lineage recovery |
