...
- PHP: arbitrary receiver-chain and interprocedural object-call inference beyond the currently bounded typed-property, property-chain, local-alias, and declared method-return-type proof
