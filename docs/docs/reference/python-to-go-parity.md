...
- SQL/dbt: compiled lineage maturity remains partial even though the runtime is Go-owned; remaining gaps are unresolved refs, truly opaque templated expressions, complex macros, and richer derived expressions
