...
- Arbitrary receiver chains and interprocedural aliasing still require stronger end-to-end proof and type propagation beyond obvious same-class typed properties and bounded local aliases
