...
- Arbitrary receiver chains and interprocedural aliasing still require stronger end-to-end proof and type propagation beyond obvious same-class typed properties, typed property chains, bounded local aliases, and declared method-return-type aliases
