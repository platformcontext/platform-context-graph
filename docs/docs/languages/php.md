...
- Broader receiver-qualified object call inference still requires stronger end-to-end proof and type propagation beyond obvious same-class typed properties
