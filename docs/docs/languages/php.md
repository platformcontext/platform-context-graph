...
| Classes | `classes` | supported | `interfaces` | `name, line_number` | `node:Class` | `tests/unit/parsers/test_php_parser.py::test_parse_classes` | `tests/integration/test_language_graph.py::TestPhpGraph::test_runtime_surface` | - |
| Interfaces | `interfaces` | supported | `classes` | `name, line_number` | `node:Interface` | `tests/unit/parsers/test_php_parser.py::test_parse_interfaces` | `tests/integration/test_language_graph.py::TestPhpGraph::test_runtime_surface` | - |
