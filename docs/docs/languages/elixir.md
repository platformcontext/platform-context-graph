...
Canonical source: `src/platform_context_graph/tools/parser_capabilities/specs/elixir.yaml`

## Parser Contract
- Language: `elixir`
- Family: `language`
- Parser: `ElixirTreeSitterParser`
- Entrypoint: `src/platform_context_graph/tools/languages/elixir.py`
