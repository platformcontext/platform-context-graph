...
- Notes:
  ...
  - JSDoc and method-kind semantics already survive parse and content
    ...
    `dead-code`, `code/relationships`, `code/complexity`, and
    `entities/resolve` now also carry the same graph-backed JavaScript
    ...
    it. `language-query`, `code/search`, `entities/resolve`, and JavaScript
    ...
    beyond `language-query`, `code/search`, `entities/resolve`, JavaScript
