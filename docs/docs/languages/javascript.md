...
- Notes:
  ...
  - JSDoc and method-kind semantics already survive parse and content
    ...
    beyond `language-query`, `code/search`, `entities/resolve`, `code/call-chain`,
    JavaScript entity-context/story, and the shared `dead-code`/`code/relationships`/`code/complexity`
