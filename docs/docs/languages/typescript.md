...
- Notes:
  ...
  - Type aliases are queryable through the Go content-backed APIs, the normal
    ...
    names as well as source text. Graph-backed `language-query`,
    ...
    graph-backed entities. Dedicated graph/story/context surfacing remains
    partial.
