...
- Notes:
  ...
  - Type annotations are queryable through the Go content-backed APIs, the
    ...
    metadata. Entity-context also emits semantic summaries for Python
    decorator, async, and type-annotation semantics. Fully first-class
