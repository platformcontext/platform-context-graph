...
## Known Limitations
- Truly anonymous inline lambdas that are not bound to a stable target remain
  ordinary expressions rather than first-class entities.
