...
- TSX-specific type narrowing patterns such as `as ComponentType<...>` now have
  ...
  partial
- JSX component-reference edges are still synthesized from content metadata
  when the graph does not yet contain direct `REFERENCES` edges
