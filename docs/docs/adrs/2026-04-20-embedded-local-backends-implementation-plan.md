...
- open the SQL-edge hot-path NornicDB PR from `linuxdynasty/NornicDB:pcg-sql-edge-hotpath`, then rerun the same self-repo dogfood after merge from upstream `main`
