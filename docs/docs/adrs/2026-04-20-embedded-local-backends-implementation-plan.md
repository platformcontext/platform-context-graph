...
**Status:** In Progress (local host, local-authoritative path, and backend conformance shipped; Neo4j parity research, install trust, OCI plugins, and support-path closure remain)
...
**Remaining work:** keep latest-main NornicDB validation current, complete the
Neo4j parity optimization research plan, finish the install trust policy and
broader host envelope, complete OCI/plugin contract work, and only then decide
whether Neo4j remains a production-promoted alternative or moves to a narrower
support posture. Graph-analysis work has shipped useful local-authoritative read
