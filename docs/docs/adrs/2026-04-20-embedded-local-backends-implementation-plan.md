...
| Started | 5, 5b | Backend conformance now has a matrix, DB-free Go harness, live Compose-backed adapter check, and explicit NornicDB profile gates for `local_authoritative`, `local_full_stack`, and `production`. |
