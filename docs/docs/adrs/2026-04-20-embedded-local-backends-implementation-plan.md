...
| Started | 5 | Backend conformance now has a matrix, DB-free Go harness, and live Compose-backed adapter check. Profile runs still need to be wired before this chunk is closed. |
